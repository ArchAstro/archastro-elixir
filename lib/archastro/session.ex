...
defmodule ArchAstro.SDK.Session do
  @moduledoc """
  ...
  alias ArchAstro.SDK.{Auth, Client, TokenServer}
  ...
  @spec login(
          ...
          {:ok, Client.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def login(token_server, session_id, email, password, opts \\ [])
    ...
    input = %ArchAstro.SDK.Types.Operations.PostApiV1AuthLogin.AuthInput{
      email: email,
      password: password
    }
