...
# Content hash: e7f1e102bcbf

defmodule ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Params do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          owner_scope: String.t() | ArchAstro.Unset.t()
        }
...
defmodule ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response.Nested.DataItem do
  @moduledoc """
  DataItem API model.
  """
...
defmodule ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response do
  @moduledoc """
  Successful response
  """
  ...
  @type t :: %__MODULE__{
          data: [ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response.Nested.DataItem.t()],
          has_next: boolean(),
          has_prev: boolean(),
          page: integer(),
          page_size: integer(),
  ...
  @fields [
    data:
      {"data",
       {:list, {:ref, ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response.Nested.DataItem}}},
...
defmodule ArchAstro.Types.Operations.PostApiV1KnowledgeSources.Input do
  @moduledoc """
...
defmodule ArchAstro.Types.Operations.PatchApiV1KnowledgeSourcesSource.Input do
  @moduledoc """
...
defmodule ArchAstro.Types.Operations.PostApiV1KnowledgeSourcesSourceIngest.Input.Nested.Content do
  @moduledoc """
  Content API model.
  """
  @enforce_keys [:data]
...
defmodule ArchAstro.Types.Operations.PostApiV1KnowledgeSourcesSourceIngest.Input do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          content:
            ArchAstro.Types.Operations.PostApiV1KnowledgeSourcesSourceIngest.Input.Nested.Content.t()
            | ArchAstro.Unset.t(),
          dedupe: boolean() | ArchAstro.Unset.t(),
          file: String.t() | ArchAstro.Unset.t(),
          metadata: %{optional(String.t()) => ArchAstro.JSON.t()} | ArchAstro.Unset.t(),
          pull: boolean() | ArchAstro.Unset.t(),
  ...
  @fields [
    content:
      {"content",
       {:optional,
        {:ref,
         ArchAstro.Types.Operations.PostApiV1KnowledgeSourcesSourceIngest.Input.Nested.Content}}},
...
defmodule ArchAstro.V1.KnowledgeSources do
  @moduledoc """
  ...
  Successful response
  """
  @spec list(ArchAstro.Client.t(), ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Params.t()) ::
          {:ok, ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response.t()}
          | {:error, ArchAstro.Error.reason()}
  def list(client, params \\ %ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Params{}) do
    path = "/api/v1/knowledge_sources"

    ArchAstro.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.Types.Operations.GetApiV1KnowledgeSources.Response}
    )
  end
  ...
  """
  @spec create(ArchAstro.Client.t(), ArchAstro.Types.Operations.PostApiV1KnowledgeSources.Input.t()) ::
          {:ok, ArchAstro.Types.KnowledgeSource.t()} | {:error, ArchAstro.Error.reason()}
  def create(client, input) do
    path = "/api/v1/knowledge_sources"

    ArchAstro.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.Types.KnowledgeSource}
    )
  end
  ...
  def delete(client, source) do
    path = "/api/v1/knowledge_sources/#{ArchAstro.Path.encode(source)}"
  ...
  def get(client, source) do
    path = "/api/v1/knowledge_sources/#{ArchAstro.Path.encode(source)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.KnowledgeSource})
  end
  ...
  @spec update(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PatchApiV1KnowledgeSourcesSource.Input.t()
        ) :: {:ok, ArchAstro.Types.KnowledgeSource.t()} | {:error, ArchAstro.Error.reason()}
  ...
  **Pull mode** (`pull: true`) — re-triggers ingestion using the source's own configured
  ...
  @spec ingest(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PostApiV1KnowledgeSourcesSourceIngest.Input.t()
        ) :: {:ok, ArchAstro.Types.ContextIngestion.t()} | {:error, ArchAstro.Error.reason()}
  def ingest(client, source, input) do
    path = "/api/v1/knowledge_sources/#{ArchAstro.Path.encode(source)}/ingest"
...
defmodule ArchAstro.V1.KnowledgeSources.Kinds do
  @moduledoc """
  ...
  @spec list(ArchAstro.Client.t()) ::
          {:ok, ArchAstro.Types.KnowledgeSourceKindListResponse.t()}
          | {:error, ArchAstro.Error.reason()}
  def list(client) do
    path = "/api/v1/knowledge_sources/kinds"

    ArchAstro.HTTP.request(client, :get, path,
      decode: {:ref, ArchAstro.Types.KnowledgeSourceKindListResponse}
    )
  end
end
