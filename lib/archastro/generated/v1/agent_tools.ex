...
# Content hash: 7fd6fa911862

defmodule ArchAstro.SDK.Types.Operations.GetApiV1AgentTools.Params do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.PatchApiV1AgentToolsTool.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.V1.AgentTools do
  @moduledoc """
  ...
  """
  @spec list(ArchAstro.SDK.Client.t(), ArchAstro.SDK.Types.Operations.GetApiV1AgentTools.Params.t()) ::
          {:ok, ArchAstro.SDK.Types.AgentToolListResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def list(client, params \\ %ArchAstro.SDK.Types.Operations.GetApiV1AgentTools.Params{}) do
  ...
  """
  @spec catalog(ArchAstro.SDK.Client.t()) ::
          {:ok, [ArchAstro.SDK.Types.BuiltinToolCatalogEntry.t()]}
          | {:error, ArchAstro.SDK.Error.reason()}
  def catalog(client) do
    path = "/api/v1/agent_tools/catalog"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      decode: {:list, {:ref, ArchAstro.SDK.Types.BuiltinToolCatalogEntry}}
    )
  end
  ...
  def delete(client, tool) do
    path = "/api/v1/agent_tools/#{ArchAstro.SDK.Path.encode(tool)}"
  ...
  def get(client, tool) do
    path = "/api/v1/agent_tools/#{ArchAstro.SDK.Path.encode(tool)}"
    ArchAstro.SDK.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.SDK.Types.AgentTool})
  end
  ...
  @spec update(
          ...
          String.t(),
          ArchAstro.SDK.Types.Operations.PatchApiV1AgentToolsTool.Input.t()
        ) :: {:ok, ArchAstro.SDK.Types.AgentTool.t()} | {:error, ArchAstro.SDK.Error.reason()}
  ...
  def activate(client, tool) do
    path = "/api/v1/agent_tools/#{ArchAstro.SDK.Path.encode(tool)}/activate"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.SDK.Types.AgentTool})
  end
  ...
  """
  @spec deactivate(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, ArchAstro.SDK.Types.AgentTool.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def deactivate(client, tool) do
    path = "/api/v1/agent_tools/#{ArchAstro.SDK.Path.encode(tool)}/deactivate"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.SDK.Types.AgentTool})
  end
end
