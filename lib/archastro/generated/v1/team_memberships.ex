...
# Content hash: dfa4f841d211

defmodule ArchAstro.SDK.Types.Operations.GetApiV1TeamMemberships.Params do
  @moduledoc """
...
defmodule ArchAstro.SDK.V1.TeamMemberships do
  @moduledoc """
  ...
  @spec list(
          ...
          ArchAstro.SDK.Types.Operations.GetApiV1TeamMemberships.Params.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.TeamMembershipListResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def list(client, params \\ %ArchAstro.SDK.Types.Operations.GetApiV1TeamMemberships.Params{}) do
    path = "/api/v1/team_memberships"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.SDK.Types.TeamMembershipListResponse}
    )
  end
  ...
  def delete(client, team_membership) do
    path = "/api/v1/team_memberships/#{ArchAstro.SDK.Path.encode(team_membership)}"
