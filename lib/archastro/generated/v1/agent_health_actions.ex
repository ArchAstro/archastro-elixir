...
# Content hash: 9cc235c4bcd7

defmodule ArchAstro.V1.AgentHealthActions do
  @moduledoc """
  ...
  @spec get(ArchAstro.Client.t(), String.t()) ::
          {:ok, ArchAstro.Types.AgentHealthAction.t()} | {:error, ArchAstro.Error.reason()}
  def get(client, health_action) do
    path = "/api/v1/agent_health_actions/#{ArchAstro.Path.encode(health_action)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.AgentHealthAction})
  end
  ...
  """
  @spec verify(ArchAstro.Client.t(), String.t()) ::
          {:ok, ArchAstro.Types.AgentHealthAction.t()} | {:error, ArchAstro.Error.reason()}
  def verify(client, health_action) do
    path = "/api/v1/agent_health_actions/#{ArchAstro.Path.encode(health_action)}/verify"
    ArchAstro.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.Types.AgentHealthAction})
  end
end
