...
# Content hash: 7dd8b8fcbbc7

defmodule ArchAstro.SDK.V1.AgentHealthActions do
  @moduledoc """
  ...
  @spec get(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, ArchAstro.SDK.Types.AgentHealthAction.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def get(client, health_action) do
    path = "/api/v1/agent_health_actions/#{ArchAstro.SDK.Path.encode(health_action)}"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      decode: {:ref, ArchAstro.SDK.Types.AgentHealthAction}
    )
  end
  ...
  """
  @spec verify(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, ArchAstro.SDK.Types.AgentHealthAction.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def verify(client, health_action) do
    path = "/api/v1/agent_health_actions/#{ArchAstro.SDK.Path.encode(health_action)}/verify"
