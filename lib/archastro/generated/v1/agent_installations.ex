...
# Content hash: 99bd74d742b8

defmodule ArchAstro.Types.Operations.GetApiV1AgentInstallations.Params do
  @moduledoc """
...
defmodule ArchAstro.Types.Operations.PostApiV1AgentInstallationsInstallationSuspend.Input do
  @moduledoc """
...
defmodule ArchAstro.Types.Operations.PostApiV1AgentInstallationsInstallationInstallationSources.Input do
  @moduledoc """
...
defmodule ArchAstro.V1.AgentInstallations do
  @moduledoc """
  ...
  """
  @spec list(ArchAstro.Client.t(), ArchAstro.Types.Operations.GetApiV1AgentInstallations.Params.t()) ::
          {:ok, ArchAstro.Types.InstallationListResponse.t()} | {:error, ArchAstro.Error.reason()}
  def list(client, params \\ %ArchAstro.Types.Operations.GetApiV1AgentInstallations.Params{}) do
  ...
  def delete(client, installation) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}"
  ...
  def get(client, installation) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.Installation})
  end
  ...
  def activate(client, installation) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}/activate"
    ArchAstro.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.Types.Installation})
  end
  ...
  def pause(client, installation) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}/pause"
    ArchAstro.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.Types.Installation})
  end
  ...
  @spec suspend(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PostApiV1AgentInstallationsInstallationSuspend.Input.t()
        ) :: {:ok, ArchAstro.Types.Installation.t()} | {:error, ArchAstro.Error.reason()}
  def suspend(client, installation, input) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}/suspend"
...
defmodule ArchAstro.V1.AgentInstallations.InstallationSources do
  @moduledoc """
  ...
  @spec list(ArchAstro.Client.t(), String.t()) ::
          {:ok, ArchAstro.Types.InstallationSourceListResponse.t()}
          | {:error, ArchAstro.Error.reason()}
  def list(client, installation) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}/installation_sources"

    ArchAstro.HTTP.request(client, :get, path,
      decode: {:ref, ArchAstro.Types.InstallationSourceListResponse}
    )
  end
  ...
  @spec create(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PostApiV1AgentInstallationsInstallationInstallationSources.Input.t()
        ) :: {:ok, ArchAstro.Types.InstallationSource.t()} | {:error, ArchAstro.Error.reason()}
  def create(client, installation, input) do
    path = "/api/v1/agent_installations/#{ArchAstro.Path.encode(installation)}/installation_sources"

    ArchAstro.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.Types.InstallationSource}
    )
  end
end
