...
# Content hash: 5ace4a1be7e8

defmodule ArchAstro.Types.Operations.PutApiV1ArtifactsArtifact.Input.Nested.File do
  @moduledoc """
  File API model.
  """
  @enforce_keys [:data]
...
defmodule ArchAstro.Types.Operations.PutApiV1ArtifactsArtifact.Input do
  @moduledoc """
  Update an artifact
  """
  ...
  @fields [
    ...
    file:
      {"file",
       {:optional, {:ref, ArchAstro.Types.Operations.PutApiV1ArtifactsArtifact.Input.Nested.File}}},
...
defmodule ArchAstro.Types.Operations.GetApiV1ArtifactsArtifactContent.Params do
  @moduledoc """
...
defmodule ArchAstro.V1.Artifacts do
  @moduledoc """
  ...
  def delete(client, artifact) do
    path = "/api/v1/artifacts/#{ArchAstro.Path.encode(artifact)}"
  ...
  @spec get(ArchAstro.Client.t(), String.t()) ::
          {:ok, ArchAstro.Types.Artifact.t()} | {:error, ArchAstro.Error.reason()}
  def get(client, artifact) do
    path = "/api/v1/artifacts/#{ArchAstro.Path.encode(artifact)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.Artifact})
  end
  ...
  @spec replace(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PutApiV1ArtifactsArtifact.Input.t()
        ) :: {:ok, ArchAstro.Types.Artifact.t()} | {:error, ArchAstro.Error.reason()}
  def replace(client, artifact, input) do
    ...
    ArchAstro.HTTP.request(client, :put, path,
      body: input,
      decode: {:ref, ArchAstro.Types.Artifact}
    )
  end
  ...
  def archive(client, artifact) do
    path = "/api/v1/artifacts/#{ArchAstro.Path.encode(artifact)}/archive"
  ...
  @spec content(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.GetApiV1ArtifactsArtifactContent.Params.t()
        ) :: {:ok, Req.Response.t()} | {:error, ArchAstro.Error.reason()}
  def content(
        client,
        artifact,
        params \\ %ArchAstro.Types.Operations.GetApiV1ArtifactsArtifactContent.Params{}
      ) do
    path = "/api/v1/artifacts/#{ArchAstro.Path.encode(artifact)}/content"
