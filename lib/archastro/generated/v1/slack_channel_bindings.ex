...
defmodule ArchAstro.Types.Operations.GetApiV1SlackChannelBindingsChannelDeliveryOutcomes.Params do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          since: String.t() | ArchAstro.Unset.t(),
          outcome: String.t() | ArchAstro.Unset.t(),
...
defmodule ArchAstro.V1.SlackChannelBindings do
  ...
  @spec delivery_outcomes(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.GetApiV1SlackChannelBindingsChannelDeliveryOutcomes.Params.t()
        ) ::
          {:ok, ArchAstro.Types.SlackDeliveryOutcomeListResponse.t()}
          | {:error, ArchAstro.Error.reason()}
  def delivery_outcomes(
        client,
        channel,
        params \\ %ArchAstro.Types.Operations.GetApiV1SlackChannelBindingsChannelDeliveryOutcomes.Params{}
      ) do
    path = "/api/v1/slack_channel_bindings/#{ArchAstro.Path.encode(channel)}/delivery_outcomes"

    ArchAstro.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.Types.SlackDeliveryOutcomeListResponse}
    )
  end
