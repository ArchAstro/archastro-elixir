...
defmodule ArchAstro.SDK.Types.Operations.PostApiV1SlackChannelBindingsAssign.Input do
  @moduledoc """
  Assign a Slack channel's resident agent
  """
  @enforce_keys [:agent_user_id, :channel_id, :slack_team_id]
  defstruct agent_user_id: nil, channel_id: nil, slack_team_id: nil
  ...
  @fields [
    agent_user_id: {"agent_user_id", :string},
    channel_id: {"channel_id", :string},
    slack_team_id: {"slack_team_id", :string}
  ]
  @spec from_map(ArchAstro.SDK.JSON.object()) :: t()
...
defmodule ArchAstro.SDK.V1.SlackChannelBindings do
  ...
  @spec assign(
          ArchAstro.SDK.Client.t(),
          ArchAstro.SDK.Types.Operations.PostApiV1SlackChannelBindingsAssign.Input.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.SlackChannelBinding.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def assign(client, input) do
    path = "/api/v1/slack_channel_bindings/assign"
