...
# Content hash: 63824ea3c948

defmodule ArchAstro.SDK.Types.Operations.GetOauthScopes.Response do
  @moduledoc """
  Successful response
  """
  @enforce_keys [:scopes]
  ...
  @type t :: %__MODULE__{
          scopes: %{optional(String.t()) => ArchAstro.SDK.JSON.t()}
        }
...
defmodule ArchAstro.SDK.Types.Operations.PostOauthToken.Input do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          client: String.t() | ArchAstro.SDK.Unset.t(),
          code: String.t() | ArchAstro.SDK.Unset.t(),
          code_verifier: String.t() | ArchAstro.SDK.Unset.t(),
          device_code: String.t() | ArchAstro.SDK.Unset.t(),
          grant_type: String.t(),
...
defmodule ArchAstro.SDK.Types.Operations.PostOauthDeviceApprove.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.GetOauthDeviceAuthorization.Params do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.PostOauthDeviceAuthorize.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.PostOauthDeviceDeny.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.V1.Oauth do
  @moduledoc """
  Oauth API resource.
  """
  ...
  Successful response
  """
  @spec scopes(ArchAstro.SDK.Client.t()) ::
          {:ok, ArchAstro.SDK.Types.Operations.GetOauthScopes.Response.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def scopes(client) do
    path = "/oauth/scopes"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      decode: {:ref, ArchAstro.SDK.Types.Operations.GetOauthScopes.Response}
    )
  end
  ...
  """
  @spec token(ArchAstro.SDK.Client.t(), ArchAstro.SDK.Types.Operations.PostOauthToken.Input.t()) ::
          {:ok, ArchAstro.SDK.Types.OAuthTokenResponse.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def token(client, input) do
    path = "/oauth/token"

    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.OAuthTokenResponse}
    )
  end
end

defmodule ArchAstro.SDK.V1.Oauth.Device do
  @moduledoc """
  Device API resource.
  """
  ...
  @spec approve(
          ...
          ArchAstro.SDK.Types.Operations.PostOauthDeviceApprove.Input.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.DeviceAuthorizationStatusResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def approve(client, input) do
    ...
    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.DeviceAuthorizationStatusResponse}
    )
  end
  ...
  @spec authorization(
          ArchAstro.SDK.Client.t(),
          ArchAstro.SDK.Types.Operations.GetOauthDeviceAuthorization.Params.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.DeviceAuthorizationDetailsResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def authorization(client, params) do
    ...
    ArchAstro.SDK.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.SDK.Types.DeviceAuthorizationDetailsResponse}
    )
  end
  ...
  @spec authorize(
          ArchAstro.SDK.Client.t(),
          ArchAstro.SDK.Types.Operations.PostOauthDeviceAuthorize.Input.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.DeviceAuthorizationResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def authorize(client, input) do
    ...
    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.DeviceAuthorizationResponse}
    )
  end
  ...
  """
  @spec deny(ArchAstro.SDK.Client.t(), ArchAstro.SDK.Types.Operations.PostOauthDeviceDeny.Input.t()) ::
          {:ok, ArchAstro.SDK.Types.DeviceAuthorizationStatusResponse.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
