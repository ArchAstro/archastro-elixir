...
# Content hash: 1f727ce96ec7

defmodule ArchAstro.V1.Trajectories do
  @moduledoc """
  ...
  @spec get(ArchAstro.Client.t(), String.t()) ::
          {:ok, ArchAstro.Types.Trajectory.t()} | {:error, ArchAstro.Error.reason()}
  def get(client, trajectory) do
    path = "/api/v1/trajectories/#{ArchAstro.Path.encode(trajectory)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.Trajectory})
  end
  ...
  def contents(client, trajectory) do
    path = "/api/v1/trajectories/#{ArchAstro.Path.encode(trajectory)}/contents"
