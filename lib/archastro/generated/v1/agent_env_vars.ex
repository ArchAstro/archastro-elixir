...
# Content hash: 33a0bfcc72df

defmodule ArchAstro.Types.Operations.PatchApiV1AgentEnvVarsEnvVar.Input do
  @moduledoc """
...
defmodule ArchAstro.V1.AgentEnvVars do
  @moduledoc """
  ...
  def delete(client, env_var) do
    path = "/api/v1/agent_env_vars/#{ArchAstro.Path.encode(env_var)}"
  ...
  def get(client, env_var) do
    path = "/api/v1/agent_env_vars/#{ArchAstro.Path.encode(env_var)}"
    ArchAstro.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.Types.AgentEnvVarMasked})
  end
  ...
  @spec update(
          ArchAstro.Client.t(),
          String.t(),
          ArchAstro.Types.Operations.PatchApiV1AgentEnvVarsEnvVar.Input.t()
        ) :: {:ok, ArchAstro.Types.AgentEnvVarMasked.t()} | {:error, ArchAstro.Error.reason()}
