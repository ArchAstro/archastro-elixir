...
# Content hash: c7490727a4e3

defmodule ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Params do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response.Nested.DataItem do
  @moduledoc """
  DataItem API model.
  """
  ...
  @type t :: %__MODULE__{
          archived_at: DateTime.t() | ArchAstro.SDK.Unset.t(),
          created_at: DateTime.t(),
          id: String.t(),
          read_at: DateTime.t() | ArchAstro.SDK.Unset.t(),
          rendered: %{optional(String.t()) => ArchAstro.SDK.JSON.t()},
          status: String.t(),
          type: String.t()
        }
...
defmodule ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response do
  @moduledoc """
  Successful response
  """
  ...
  @type t :: %__MODULE__{
          ...
          data: [ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response.Nested.DataItem.t()],
          has_more: boolean()
        }
  ...
  @fields [
    ...
    data:
      {"data",
       {:list,
        {:ref, ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response.Nested.DataItem}}},
...
defmodule ArchAstro.SDK.Types.Operations.PostApiV1NotificationsSend.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.GetApiV1NotificationsUnreadCount.Response do
  @moduledoc """
  Successful response
  """
  @enforce_keys [:count]
...
defmodule ArchAstro.SDK.V1.Notifications do
  @moduledoc """
  ...
  @spec list(
          ...
          ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Params.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def list(client, params \\ %ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Params{}) do
    path = "/api/v1/notifications"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.SDK.Types.Operations.GetApiV1Notifications.Response}
    )
  end
  ...
  No content
  """
  @spec read_all(ArchAstro.SDK.Client.t()) :: {:ok, :ok} | {:error, ArchAstro.SDK.Error.reason()}
  ...
  @spec send(
          ArchAstro.SDK.Client.t(),
          ArchAstro.SDK.Types.Operations.PostApiV1NotificationsSend.Input.t()
        ) :: {:ok, ArchAstro.SDK.Types.Notification.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def send(client, input) do
    path = "/api/v1/notifications/send"

    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.Notification}
    )
  end
  ...
  Successful response
  """
  @spec unread_count(ArchAstro.SDK.Client.t()) ::
          {:ok, ArchAstro.SDK.Types.Operations.GetApiV1NotificationsUnreadCount.Response.t()}
          | {:error, ArchAstro.SDK.Error.reason()}
  def unread_count(client) do
    path = "/api/v1/notifications/unread_count"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      decode: {:ref, ArchAstro.SDK.Types.Operations.GetApiV1NotificationsUnreadCount.Response}
    )
  end
  ...
  def archive(client, notification) do
    path = "/api/v1/notifications/#{ArchAstro.SDK.Path.encode(notification)}/archive"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: :void)
  end
  ...
  No content
  """
  @spec read(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, :ok} | {:error, ArchAstro.SDK.Error.reason()}
  def read(client, notification) do
    path = "/api/v1/notifications/#{ArchAstro.SDK.Path.encode(notification)}/read"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: :void)
  end
  ...
  No content
  """
  @spec unarchive(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, :ok} | {:error, ArchAstro.SDK.Error.reason()}
  def unarchive(client, notification) do
    path = "/api/v1/notifications/#{ArchAstro.SDK.Path.encode(notification)}/unarchive"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: :void)
  end
end
