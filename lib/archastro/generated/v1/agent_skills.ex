...
# Content hash: a560d1fd70e5

defmodule ArchAstro.SDK.Types.Operations.GetApiV1AgentSkills.Params do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.PostApiV1AgentSkills.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.Types.Operations.PatchApiV1AgentSkillsAgentSkill.Input do
  @moduledoc """
...
defmodule ArchAstro.SDK.V1.AgentSkills do
  @moduledoc """
  ...
  @spec list(
          ...
          ArchAstro.SDK.Types.Operations.GetApiV1AgentSkills.Params.t()
        ) :: {:ok, ArchAstro.SDK.Types.AgentSkillList.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def list(client, params \\ %ArchAstro.SDK.Types.Operations.GetApiV1AgentSkills.Params{}) do
    path = "/api/v1/agent_skills"

    ArchAstro.SDK.HTTP.request(client, :get, path,
      query: params,
      decode: {:ref, ArchAstro.SDK.Types.AgentSkillList}
    )
  end
  ...
  @spec create(
          ArchAstro.SDK.Client.t(),
          ArchAstro.SDK.Types.Operations.PostApiV1AgentSkills.Input.t()
        ) :: {:ok, ArchAstro.SDK.Types.AgentSkill.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def create(client, input) do
    path = "/api/v1/agent_skills"

    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.AgentSkill}
    )
  end
  ...
  def delete(client, agent_skill) do
    path = "/api/v1/agent_skills/#{ArchAstro.SDK.Path.encode(agent_skill)}"
  ...
  def get(client, agent_skill) do
    path = "/api/v1/agent_skills/#{ArchAstro.SDK.Path.encode(agent_skill)}"
    ArchAstro.SDK.HTTP.request(client, :get, path, decode: {:ref, ArchAstro.SDK.Types.AgentSkill})
  end
  ...
  @spec update(
          ArchAstro.SDK.Client.t(),
          String.t(),
          ArchAstro.SDK.Types.Operations.PatchApiV1AgentSkillsAgentSkill.Input.t()
        ) :: {:ok, ArchAstro.SDK.Types.AgentSkill.t()} | {:error, ArchAstro.SDK.Error.reason()}
  ...
  def activate(client, agent_skill) do
    path = "/api/v1/agent_skills/#{ArchAstro.SDK.Path.encode(agent_skill)}/activate"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.SDK.Types.AgentSkill})
  end
  ...
  def deactivate(client, agent_skill) do
    path = "/api/v1/agent_skills/#{ArchAstro.SDK.Path.encode(agent_skill)}/deactivate"
    ArchAstro.SDK.HTTP.request(client, :post, path, decode: {:ref, ArchAstro.SDK.Types.AgentSkill})
  end
end
