...
# Content hash: 4cc2085283b3

defmodule ArchAstro.SDK.Types.Operations.PostApiV1AgentComputersComputerExec.Input do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          command: String.t(),
          dir: String.t() | ArchAstro.SDK.Unset.t()
        }
...
defmodule ArchAstro.SDK.V1.AgentComputers do
  @moduledoc """
  ...
  def delete(client, computer) do
    path = "/api/v1/agent_computers/#{ArchAstro.SDK.Path.encode(computer)}"
  ...
  @spec exec(
          ...
          String.t(),
          ArchAstro.SDK.Types.Operations.PostApiV1AgentComputersComputerExec.Input.t()
        ) ::
          {:ok, ArchAstro.SDK.Types.ComputerExecResult.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def exec(client, computer, input) do
    path = "/api/v1/agent_computers/#{ArchAstro.SDK.Path.encode(computer)}/exec"

    ArchAstro.SDK.HTTP.request(client, :post, path,
      body: input,
      decode: {:ref, ArchAstro.SDK.Types.ComputerExecResult}
    )
  end
  ...
  """
  @spec refresh(ArchAstro.SDK.Client.t(), String.t()) ::
          {:ok, ArchAstro.SDK.Types.AgentComputer.t()} | {:error, ArchAstro.SDK.Error.reason()}
  def refresh(client, computer) do
    path = "/api/v1/agent_computers/#{ArchAstro.SDK.Path.encode(computer)}/refresh"
