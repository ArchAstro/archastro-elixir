...
const ALLOWED = {
  "GHSA-qxc2-j82w-r537": {
    ...
    reason:
      ...
      "contract test. Not reachable as we run Prism: test/support/contract_support.ex start_prism!/0 " +
      ...
      "nothing. Prism is a devDependency and is never part of the published Hex package.",
  },
};
